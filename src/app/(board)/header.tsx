...
export function Header() {
  ...
  function handleSearchUpdate(event: ChangeEvent<HTMLInputElement>) {
    setSearch(event.target.value, {
      limitUrlUpdates: event.target.value !== '' ? debounce(700) : undefined
    })
  }
    ...
    return (
      <div className="max-w-[900px] mx-auto w-full flex items-center justify-between">
        <div className="space-y-1" >
          ...
          <p className="text-sm text-navy-200">Follow the development progress of our entire platform</p>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          {isPending ? (
            <div className="size-8 cursor-pointer rounded-full bg-navy-700 border border-navy-500 flex items-center justify-center">
            ...
            <button
              ...
              className="size-8 cursor-pointer rounded-full bg-navy-700 border border-navy-500 flex items-center justify-center
